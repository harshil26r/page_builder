...
import { LuLayoutGrid, LuSparkles, LuLogOut, LuUser, LuUsers } from "react-icons/lu";
      ...
      <aside className="fixed left-0 top-0 flex flex-col w-20 items-center bg-[#0a0f1d]/95 border-r border-white/10 text-slate-400 backdrop-blur-2xl py-6 px-3 h-screen z-50 shrink-0 shadow-2xl">
        ...
        <div className="flex flex-col items-center flex-1 space-y-8 w-full">
          ...
          <nav className="flex flex-col space-y-4 w-full items-center">
            ...
            <button
              ...
              className="relative group flex h-11 w-11 items-center justify-center rounded-2xl text-slate-400 hover:bg-white/5 hover:text-slate-100 border border-transparent transition-all duration-200"
              title="Team Workspace & Roles"
            >
              <LuUsers className="text-xl transition-transform group-hover:scale-110" />
            </button>
          </nav>
        </div>
        ...
        <div className="flex flex-col space-y-3 w-full items-center pt-4 border-t border-white/10">
          ...
          <div
            ...
            title="Team Workspace & User Session"
          >
